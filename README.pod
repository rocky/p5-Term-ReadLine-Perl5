...
<img src="https://travis-ci.org/rocky/p5-Term-ReadLine-Perl5.png">
...
Friedl. He referenced FSF the code Roland Schemers line_edit.pl.

Ilya Zakharevich turned this into a Perl5 module called
Term::ReadLine::Perl. Some of the changes he made include using
Term::ReadKey if present, and made this work under xterm. The file
Term/ReadLine/Perl5/CHANGES contains a list of his changes.
